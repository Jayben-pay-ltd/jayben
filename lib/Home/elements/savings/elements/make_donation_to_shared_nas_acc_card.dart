...
import 'package:jayben/Home/elements/savings/elements/donate_to_shared_nas_account.dart';

class DonateToSharedNasAccountCard extends StatefulWidget {
  const DonateToSharedNasAccountCard({super.key, required this.account_id});

  final String account_id;

  @override
  State<DonateToSharedNasAccountCard> createState() =>
      _DonateToSharedNasAccountCardState();
}

class _DonateToSharedNasAccountCardState
    extends State<DonateToSharedNasAccountCard> {
  @override
  void initState() {
    super.initState();
    onDialogueLoad();
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text.rich(
                            TextSpan(
                              text:
                                  number_of_hours_left.toString().split(".")[0],
                              children: [
                                TextSpan(
                      ...
                      hGap(20),
                      Text(
                        "This account is owned by ${account_map!["account_holder_details"]["first_name"]} ${account_map!["account_holder_details"]["last_name"]}",
                        textAlign: TextAlign.center,
                        style: googleStyle(
                          color: Colors.grey[700]!,
                          size: 15,
