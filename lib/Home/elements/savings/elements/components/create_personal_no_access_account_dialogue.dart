...
class CreatePersonalNoAccessAccountDialogue extends StatefulWidget {
  const CreatePersonalNoAccessAccountDialogue({Key? key}) : super(key: key);

  @override
  State<CreatePersonalNoAccessAccountDialogue> createState() =>
      _CreatePersonalNoAccessAccountDialogueState();
}

class _CreatePersonalNoAccessAccountDialogueState
    extends State<CreatePersonalNoAccessAccountDialogue> {
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      hGap(20),
                      Text(
                        "Create Personal No Access Account",
                      ...
                      hGap(20),
                      Text(
                        "How many days should your money be locked for?",
                      ...
                      hGap(10),
                      Text(
                        "Example: New shoes 👢 or Long Weekend 🍷",
                        textAlign: TextAlign.center,
                        style: GoogleFonts.ubuntu(
                          color: Colors.grey[600],
                          fontSize: 13,
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          // await value.createNoAccessAccount({
                          ...
                          showSnackBar(
                              ...
                              'You can now deposit money into it and lock your money '
